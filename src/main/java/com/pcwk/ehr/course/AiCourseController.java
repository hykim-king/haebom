...
public class AiCourseController {
    ...
    /**
     * ✅ 로딩 페이지 (theme → recommend 사이 중간 단계)
     */
    @GetMapping("/ai/loading")
    public String loadingPage(@RequestParam String redirect, Model model) {
        model.addAttribute("redirectUrl", redirect);
        return "course/ai_trip_course_loading";
    }
