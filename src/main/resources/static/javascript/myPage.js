...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const hashtagData = {
        "자연": {
            icon: "🏞️",
            tags: ["산⛰️", "폭포💦", "계곡🏞️", "바다🌊", "해안절경🌅", "해수욕장🏖️", 
                   "항구/포구⚓", "등대🗼", "호수🏞️", "강🌊", "동굴🕳️"]
        },
        "역사/문화": {
            icon: "🏛️",
            tags: ["고궁🏰", "성🏯", "문🚪", "민속마을🏘️", "유적지/사적지📜", "사찰🛕", 
                   "박물관🏛️", "기념관🎖️", "전시관🖼️", "미술관/화랑🎨", "영화관🎬"]
        },
        "휴식/체험": {
            icon: "🧘",
            tags: ["온천/욕장/스파♨️", "테마공원🎡", "농.산.어촌체험🚜", 
                   "전통체험🎎", "산사체험🛕", "기념탑🗿", "전망대🔭"]
        },
        "레포츠": {
            icon: "⚽",
            tags: ["경기장🏟️", "인라인⛸️", "자전거하이킹🚴", "카트🏎️", "골프⛳", 
                   "경륜🚴", "승마🐴", "윈드서핑🏄", "제트스키🚤", "카약/카누🛶", 
                   "요트⛵", "스노쿨링🤿", "스킨스쿠버🤿", "낚시🎣", "수영🏊", 
                   "래프팅🚣", "스카이다이빙🪂", "페러글라이딩🪂"]
        }
    };
